...
set xrange [ -5.00000 : 30.0000 ] noreverse nowriteback
...
GNUTERM = "x11"
plot 'n20dBm_amp_for_fitting.l.139.linecut.dat' u 1:($2*-1) w l t 'data', 'sim_dephasing2.l.0.linecut.dat' u ($1+8):(-$2) w l t 'Qr = 10000', 'sim_dephasing2.l.16.linecut.dat' u ($1+14):(-$2) w l t 'Qr = 1500', 'sim_dephasing2.l.8.linecut.dat' u ($1+10.5):(-$2) w l t 'Qr = 5750'
#    EOF
